...
1. Inicie sesion con el comando
    
    `firebase login`

1. Cree el build con el comando

     `npm run build`

2. Suba al Servidor con el comando

     `firebase deploy`

Si tiene una sesion iniciada puede cerrar sesion con el comando 
