...
function RouterMain(props) {
  ...
  return (
    <BrowserRouter>
      <div className={user != null && openDrawer ? classes.root : null}>
        ...
        <main className={openDrawer ? classes.content : classes.contentFull}>
          ...
          <PrivateRoute isAuth={isAuth} exact={true} path={routes.registerAdditionalClass}
                        component={RegisterAdditionalClass}/>
