...
export const emailRegex = /^[a-zA-Z0-9]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/i;
export const nameRegex = /^[a-zA-ZñÑ ]+$/;
export const nameMateriaRegex = /^[a-zA-Z0-9ñÑ ]+$/;
